# Generated by Django 3.2.8 on 2021-11-14 10:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлено на обработку'), ('PRD', 'обрабатывается'), ('PD', 'оплачено'), ('RDY', 'готово к выдаче'), ('CNC', 'отменён')], default='FM', max_length=3, verbose_name='статус')),
